...
def merge_conflictes():
    ...
    x.x('git checkout main')
    x.x('git branch fruta')
    x.x('git branch verdura')
    x.x('git lga')

    print('==================== CANVIS FRUTA ========================')
    x.log_file('stdout/branques/merge_conflicts_fruta.txt')
    x.x('git checkout fruta')
    ...
    print('==================== MERGE FRUTA ========================')
    x.log_file('stdout/branques/merge_conflicts_merge_fruta.txt')
    x.x('git merge fruta')
    x.x('git lga')
